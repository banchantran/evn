...
<?php
	...
	$url2 = getParam(2, 'str');
	$url4 = getParam(4, 'str');
	$query = 'SELECT * FROM `product2_detail` WHERE lang="'.$current_lang.'" AND url = "'.$url1.'"  AND sub_url = "'.$url2.'" AND detail_url = "'.$url4.'" AND publish =2 ORDER BY region, id DESC';
                            ...
                            <div class="box-bot">
                                <div class="box-tl">
                                    <div class="box-br">
                                        ...
                                        <?php
                                        $image_file = get_image($one, 'large', 'product2_detail');
                                    if($image_file)
