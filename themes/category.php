...
<center>
	<div id="centerct">
    	<?php require_once ROOT_PATH.'template/other/url.php';?>
        <!-- Left block -->
    	<div class="leftbls01">
        	<?php require_once ROOT_PATH.'template/menu/menu_left.php';?>
            <?php require_once ROOT_PATH.'template/adv/left.php';?>
             <div style="height:5px; clear:both;"></div>
            <?php require_once ROOT_PATH.'template/contact_info/index.php';?>
