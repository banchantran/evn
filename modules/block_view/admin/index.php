...
//	Chuc nang chinh  	: 	Quan tri thong tin lien he
	...
	$file_name= DATA_PATH_ADMIN.'html/block_view/block_'.$current_lang.'.html';
...
?>
<form name="FormBlockAdmin" method="post">
<script>
	function submitbutton(pressbutton)
	{
		document.FormBlockAdmin.action.value=pressbutton;
		try
		{
			document.FormBlockAdmin.onsubmit();
		}
		catch(e)
		{}
		document.FormBlockAdmin.submit();
	}
</script>
<table class="nostyle"  border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td align="left"><h2><?php echo 'Block';?></h2></td>
			<td align="right">
